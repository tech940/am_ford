  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await submitLeadInquiry({
        ...
        message: `Submitted Trade Valuation ($500 Extra for Trade). Preferred contact: ${preferredContact}`,
      });
      ...
      <div className="trade-offer-overlay">
        <div className="trade-offer-shell trade-offer-shell--success">
          ...
          <p className="trade-offer-success-copy">
            Your trade value request has been submitted successfully. A representative will contact
            you shortly.
          </p>
          <button type="button" className="trade-offer-primary" onClick={onClose}>
            Close
          </button>
        </div>
      </div>
        ...
        <div className="trade-offer-hero">
          <div className="trade-offer-promo">
            ...
            <p className="trade-offer-promo-footnote">
              Cannot be combined with any other discounts or promotions. Please contact dealer for
              details.
            </p>
          </div>
          <div className="trade-offer-hero-image-wrap">
            <img src={TRADE_HERO_IMAGE} alt="Trade-in vehicle" className="trade-offer-hero-image" />
        ...
        <div className="trade-offer-body">
          <form onSubmit={handleSubmit} className="trade-offer-form">
            <div className="trade-offer-grid">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (invalidFields.includes("firstName")) {
                      setInvalidFields((prev) => prev.filter((field) => field !== "firstName"));
                    }
                  }}
              ...
              <label className="trade-offer-field">
                <span className="trade-offer-field-label">Preferred Contact</span>
                <select
            ...
            <div className="trade-offer-actions">
              <button type="button" className="trade-offer-secondary" onClick={onClose}>
                Not Interested
              </button>
              <button type="submit" className="trade-offer-primary" disabled={loading}>
